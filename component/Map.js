...
//       return;
//     }
//     const apiUrl = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${location.latitude},${location.longitude}&radius=5000&type=school&keyword=ESL&key=${mapsApiKey}`;
//     //const apiUrl = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=49.2721869,-123.147307&radius=5000&keyword=ESL%20school&key=${mapsApiKey}`;
//     try {
...
//   };
  ...
  function findESLHandler() {
      ...
      try {
        fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${location.latitude},${location.longitude}&radius=5000&keyword=ESL%20school&key=${mapsApiKey}`)
